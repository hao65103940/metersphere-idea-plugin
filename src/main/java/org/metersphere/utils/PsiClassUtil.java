...
import static org.metersphere.utils.ExceptionUtil.handleSyntaxError;
...
public class PsiClassUtil {
    ...
    public static boolean isNormalInterface(PsiClass psiClass, Project project) {
        if (psiClass.isInterface()) {
            ...
            boolean psiClassFromCollection = PsiTypeUtilExt.isPsiClassFromXxx(psiClass, project, "java.util.Collection");
            boolean psiClassFromMap = PsiTypeUtilExt.isPsiClassFromXxx(psiClass, project, "java.util.Map");
            // 不是 (list,map,set)
